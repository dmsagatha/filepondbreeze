    ...
    <x-slot:header>
        ...
        <div class="md:flex md:items-center py-2">
            <div class="md:w-1/2 px-10">
                <form action="{{ route('images.store') }}" method="POST" enctype="multipart/form-data" id="imagesDropzone"
                ...
                <form action="{{ route('articles.store') }}" method="POST" novalidate>
                    ...
                    <div class="mb-5">
                        ...
                        <x-text-input type="text" id="name" name="name"
                            class="block border p-3 w-full rounded-lg @error('name') border-red-500 @enderror"
                            :value="$article->name ?? old('name')" autofocus autocomplete="name" placeholder="Nombre del Artículo" />
                        @error('name')
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="description" name="description" placeholder="Tu description"
                    ...
                    <div class="mb-5">
                        <input id="nombreImagen" name="image" type="shown"
                            class="border p-3 w-full rounded-lg bg-red-50" value="{{ old('image') }}" />
                        @error('image')
                            <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
                                {{ $message }}
                            </p>
