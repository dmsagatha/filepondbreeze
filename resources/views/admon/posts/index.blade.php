                    ...
                    <table class="border-collapse table-auto w-full text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b font-medium p-2 pl-8 pt-0 pb-3 text-slate-400 text-left">Created At
                                </th>
                                <th class="border-b font-medium p-2 pl-8 pt-0 pb-3 text-slate-400 text-left">Updated At
                                </th>
                                <th class="border-b font-medium p-2 pl-8 pt-0 pb-3 text-slate-400 text-left">Updated At
                                </th>
                                ...
                                <tr>
                                    ...
                                    <td class="m-5 p-5 flex flex-row items-center">
                                        <img class="h-10 w-10 rounded-lg"
                                            src="{{ Storage::disk('public')->url('posts/' . $post->photo) }}"
